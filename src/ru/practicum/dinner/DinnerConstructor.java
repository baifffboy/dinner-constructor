...
public class DinnerConstructor {
    ...
    HashMap<String, ArrayList<String>> dinnersByType = new HashMap<String, ArrayList<String>>(); // хранилище блюд: ключ — тип блюда (например, "Суп"), значение — список названий блюд этого типа
    ...
    public void addNewDish(String dishType, String dishName) {
        ...
        if (checkType(dishType)) { //здесь мы должны проверить, содержит ли наше хранилище такое блюдо
